...
SYSCT_RCGCGPIO_R0	EQU 0x00000001		;valor para activar el puerto C
SYSCTL_PRGPIO		EQU	0x400FEA08		;dirección para verificar puerto listo
SYSCTL_PRGPIO_R0	EQU 0x00000001
...
ConfN
    ...
    ORR R0, R0, #SYSCT_RCGCGPIO_R0  ; R0 = R0|SYSCTL_RCGCGPIO_R0
    STR R0, [R1]                    ; [R1] = R0	
...
GPIOCinitloop
    ...
    ANDS R0, R0, #SYSCTL_PRGPIO_R0  ; R0 = R0&SYSCTL_PRGPIO_R%
    ;BEQ GPIOCinitloop 
